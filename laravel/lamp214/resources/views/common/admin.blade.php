        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                <ul>
                    ...
                    <li>
                        <a href="charts.html">
                            <i class="icon-graph"></i>管理员管理
                        </a>
                        <ul class="closed">
                            <li><a href="form_layouts.html">管理员列表</a></li>
                            <li><a href="form_elements.html">添加管理员</a></li>
                            <!-- <li><a href="form_wizard.html">Wizard</a></li> -->
                        </ul>
                    </li>    
                    ...
                    <li>
                        <a href="charts.html">
                            <i class="icon-graph"></i>分类管理
                        </a>
                        <ul class="closed">
                            <li><a href="form_layouts.html">分类列表</a></li>
                            <li><a href="form_elements.html">添加分类</a></li>
                            <!-- <li><a href="form_wizard.html">Wizard</a></li> -->
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="files.html">
                            <i class="icon-folder-closed"></i>购物车管理  
                        </a>
                        <ul class="closed">
                            <li><a href="form_layouts.html">购物车列表</a></li>
                    ...
                    <li>
                        ...
                        <ul class="closed">
                            <li><a href="form_layouts.html">查看订单</a></li>
                           <!--  <li><a href="form_elements.html">Elements</a></li>
                            <li><a href="form_wizard.html">Wizard</a></li> -->
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="calendar.html">
                            <i class="icon-calendar"></i>地址管理
                        </a>
                        <ul class="closed">
                            <li><a href="form_layouts.html">地址列表</a></li>
                            <!-- <li><a href="form_elements.html">添加商品</a></li> -->
                            <!-- <li><a href="form_wizard.html">Wizard</a></li> -->
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="widgets.html">
                            <i class="icon-cogs"></i>公告管理
                        </a>
                        <ul class="closed">
                            <li><a href="form_layouts.html">公告添加</a></li>
                            <li><a href="form_elements.html">公告展示</a></li>
                            <!-- <li><a href="form_wizard.html">Wizard</a></li> -->
                        </ul>
                    ...
                    <li>
                        <a href="typography.html">
                            <i class="icon-font"></i>友情链接
                        </a>
                        <ul class="closed">
                            <li><a href="form_layouts.html">链接添加</a></li>
                            <li><a href="form_elements.html">链接展示</a></li>
                        </ul>
                    </li>



                    <!-- <li><a href="grids.html"><i class="icon-th"></i> Grids &amp; Panels</a>
                        <ul class="closed">
                    ...
                    <li><a href="gallery.html"><i class="icon-pictures"></i> Gallery</a>
                        <ul class="closed">
                            <li><a href="form_layouts.html">Layouts</a></li>
                            <li><a href="form_elements.html">Elements</a></li>
                            <li><a href="form_wizard.html">Wizard</a></li>
                    ...
                    <li><a href="error.html"><i class="icon-warning-sign"></i> Error Page</a>
                        <ul class="closed">
                            <li><a href="form_layouts.html">Layouts</a></li>
                            <li><a href="form_elements.html">Elements</a></li>
                            <li><a href="form_wizard.html">Wizard</a></li>
